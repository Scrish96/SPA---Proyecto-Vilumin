    ...
    <nav
        :class="isMobile
                ...
                : (isScrolled
                    ...
                    : 'w-full h-[36%] flex py-3.5 top-0 z-50 fixed transition-all duration-180')"
    >
        ...
        <ul 
            class="md:gap-2 lg:gap-4 transition-all duration-180 "
            :class="[isMobile
                        ? 'absolute pb-10 w-[95.5%] top-17.5 bg-black px-10 duration-180 ease-in '
                        : (isScrolled 
            ...
            :class="[   isMobile
                        ...
                        'cursor-pointer transition-all duration-180',
                        activeIndex  === index 
            ...
            <button 
                class=" transition-all duration-180 overflow-hidden rounded-[10px] text-center "
                :class="isMobile
